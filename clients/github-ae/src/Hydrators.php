...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHubAE\\Schema\\AuthenticationToken', 'ApiClients\\Client\\GitHubAE\\Schema\\Repository', 'ApiClients\\Client\\GitHubAE\\Schema\\Repository\\Permissions', 'ApiClients\\Client\\GitHubAE\\Schema\\SimpleUser', 'ApiClients\\Client\\GitHubAE\\Schema\\Repository\\TemplateRepository', 'ApiClients\\Client\\GitHubAE\\Schema\\Repository\\TemplateRepository\\Owner', 'ApiClients\\Client\\GitHubAE\\Schema\\Repository\\TemplateRepository\\Permissions' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Runners🌀RegistrationToken()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubAE\\Schema\\TeamFull', 'ApiClients\\Client\\GitHubAE\\Schema\\TeamOrganization', 'ApiClients\\Client\\GitHubAE\\Schema\\TeamOrganization\\Plan' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Teams()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className) : mixed
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHubAE\\Schema\\TeamFull', 'ApiClients\\Client\\GitHubAE\\Schema\\TeamOrganization', 'ApiClients\\Client\\GitHubAE\\Schema\\TeamOrganization\\Plan' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Teams()->serializeObject($object),
